...
class SprogroupPurchaseRequest(models.Model):
    ...
    purchase_requisition_id = fields.Many2one('purchase.requisition', string="Purchase Agreement.", copy=False)
...
class SprogroupPurchaseRequestLine(models.Model):
    ...
    @api.model
    def create(self, vals):
        vals['request_product_qty'] = vals.get('product_qty')
    ...
    product_uom_id = fields.Many2one('uom.uom', 'Product Unit of Measure',
                                     track_visibility='onchange')
    request_product_qty = fields.Float('Requested Quantity', track_visibility='onchange',
    ...
    specifications = fields.Text(string='Purpose')
