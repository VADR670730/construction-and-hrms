...
class Project(models.Model):
    ...
    #Porfolio
    parent_id = fields.Many2one("project.project", string="Portfolio", domain="[('project_type', 'in', ['porfolio'])]", track_visibility="always")
    project_count = fields.Integer(string="Projects", compute="_compute_project_count")
    analytic_account_id = fields.Many2one('account.analytic.account', string="Analytic Account", copy=False, ondelete='set null',
        help="Link this project to an analytic account if you need financial management on projects. "
             "It enables you to connect projects with budgets, planning, cost and revenue analysis, timesheets on projects, etc.", track_visibility="always")
    ...
    def set_inprogress(self):
        for i in self:
            ...
            elif not i.start_date and i.project_type == 'porfolio':
                raise ValidationError(_('You must supply value on the fields:\n 1. Start Date'))
